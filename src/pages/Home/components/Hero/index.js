        ...
        <div className="carousel-inner">
          { [1, 2].map(item =>
            <div className={`carousel-item ${item === 1 ? "active" : ""}`} key={ item }>
              <img className="w-100" src={`img/carousel-${item}.jpg`} alt="Image"/>
              <div className="carousel-caption d-flex align-items-center justify-content-center text-start">
                <div className="mx-sm-5 px-5" style={{ maxWidth: 900 }}>
                  <h1 className="display-2 text-white text-uppercase mb-4 animated slideInDown">{ strings.hero.title[item] }</h1>
